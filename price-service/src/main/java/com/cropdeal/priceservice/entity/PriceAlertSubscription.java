...
@Table(name = "price_alert_subscriptions", indexes = {
        @Index(name = "idx_pas_crop_name", columnList = "cropName"),
        @Index(name = "idx_pas_user_id", columnList = "userId"),
        @Index(name = "idx_pas_user_role", columnList = "userRole"),
        ...
        @Index(name = "idx_pas_matching", columnList = "cropName, district, state, active")
})
