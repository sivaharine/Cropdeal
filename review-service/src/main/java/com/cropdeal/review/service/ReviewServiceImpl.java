...
public class ReviewServiceImpl implements ReviewService {
    ...
    public FarmerReviewResponse createReview(FarmerReviewRequest request) {
        ...
        boolean activeOrUpdatedReviewExists = reviewRepository.existsByDealerIdAndOrderIdAndStatusNot(
                request.getDealerId(), request.getOrderId(), ReviewStatus.DELETED);
        boolean deletedReviewStillUsesUniqueKey = !activeOrUpdatedReviewExists
                && reviewRepository.findByDealerIdAndOrderId(
                request.getDealerId(), request.getOrderId()).isPresent();

        if (activeOrUpdatedReviewExists || deletedReviewStillUsesUniqueKey) {
